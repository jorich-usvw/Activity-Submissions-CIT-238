...
class MusicPlayerFragment : Fragment() {
    ...
    fun loadSong(songData: String) {
        ...
        // show both name and url on one line; marquee will scroll if too long
        songTitleTextView.text = "$songName - $songUrl"
        // start marquee after a brief delay to let user see text change
        songTitleTextView.isSelected = false
        songTitleTextView.postDelayed({
